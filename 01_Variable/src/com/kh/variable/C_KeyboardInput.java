...
public class C_KeyboardInput {
	...
	public void inputScanner1() {
		...
		// 사용자에게 간단한 인적사항(이름, 나이, 키) 입력 받은 후 출력
	...
	public void inputScanner2() {
		...
		System.out.print("나이 : ");
		int age = sc.nextInt(); // 버퍼에 엔터가 남아있는 상태!!
		...
		// 결론 : sc.nextXXX() 뒤에 sc.nextLine() 메소드가 오는 경우 버퍼에 남아있는 "엔터"를 비워주는 과정 필요!
	...
	public void inputScanner4() {
		...
		*/
		...
		System.out.println("덧셈결과 : " + (num1 + num2)); // "덧셈결과 : 10" + num2 => "덧셈결과 : 105"
	 ...
	 *     버퍼에 남은 엔터를 빼주는 과정 필수!! => sc.nextLine(); 한번 더 써주면됨!
	 *   
