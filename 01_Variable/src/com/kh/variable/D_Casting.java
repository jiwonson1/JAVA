...
public class D_Casting {
	 ...
	 *        자료형 변수명 = (바꿀자료형)값;
	 *        
	 * 2. 같은 자료형끼리만 계산됨 (뿐만아니라 그 결과도 같은 자료형으로!)
	 *    값 + 값  
	 *    
	 * * 형변환 종류
	 * 1. 자동형변환 : 자동으로 형변환이 되기 때문에 명시적으로 형변환 시켜줄 필요없음!!
	 * 2. 강제형변환 : 직접 형변환해야됨! (명시적형변환)
	 *    [표현법]  (바꿀자료형)값;
	 * 
	 * * 주의사항
	...
	// 1. 자동형변환 (작은자료형을 큰 자료형으로 자동으로 형변환됨)
	public void casting1() {
		...
		//      정수형			실수형
		// 실수형은 어떠한 정수형보다도 훨씬 더 큰 범위의 값을 저장할 수 있음!!
		long l5 = 1000000000L;
		float f5 = /*(float)*/l5;
