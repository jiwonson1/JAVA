...
public class User {
	 ...
	 *  3. 매개변수를 명시적으로 작성하게되면 JVM이 기본생성자 자동으로 부여안함!
	...
	public User() {
		...
		// 기본 생성자를 작성 안해놓으면 생성 x ?
		// => 생성 된다!! => 개발자가 직접 작성안해놓으면 JVM이 자동으로 작성해줌 (매개변수있을시 안해줌)
	}
	
	// 매개변수 생성자
	// 객체 생성과 동시에 전달된 값을 매개변수로 받아서 해당 필드에 초기화할 목적
	...
	public User(String userId, String userPwd, String userName,
		...
		*/
		...
		// this() 생성자 : 같은 클래스 내에서 다른 생성자 호출 가능
		//				 반드시 첫줄에 작성해야됨!!
		this.age = age;
		this.gender = gender;
	}
