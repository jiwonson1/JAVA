...
public class C_Switch {
	 ...
	 * switch문과 if문의 차이점
	 * 
	 * if문은 조건식에서 범위지정 가능했음!! (대소비교연산자) + 동등비교연산자 + && || (논리 연산자)
	 * switch문은 확실한 값의 조건		 only 동등비교 
	 * 
	 * switch(동등비교할대상자) { // 동등비교할대상자는 반드시 int값이나, char값이나, String 만 가능
	 * case 값1 : 실행코드1; break;
	 * case 값2 : 실행코드2; break;
	 * case 값3 : 실행코드3; break;
	 * ...
	 ...
	 * }
	 * 
	 * 비교할대상자 == 값1 의 조건이 true일 경우 실행코드1을 수행하고 break 만나 빠져나감
	...
	public void method4() {
		...
		// 잘못입력했을 경우			=> "반드시 1~12월까지를 입력해야 합니다."
