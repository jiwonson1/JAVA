...
public class E_Logical {
	 ...
	 * 논리값 || 논리값  : 왼쪽, 오른쪽 둘 중에 하나라도 true일 경우   연산 결과도 true
	 */
	
	public void method1() {
		// 사용자가 입력한 정수값이 1이상 100 이하의 수인지 확인하기 (1부터 100사이의 값인지)
	...
	public void method3() {
		...
		System.out.print("종료하시려면 y 또는 Y를 입력하세요 : ");
		char ch = sc.nextLine().charAt(0);
	 ...
	 *  false && false		=> false
	 * 
	 *  --> && 연산자를 기준으로 앞의 결과가 false값이 나온다면 뒤의 조건(연산)은 궂이 실행되지 않음!!
	 *  
	 *  
	 ...
	 *  false || false		=> false
	 *  
	 *  --> || 연산자를 기준으로 앞의 결과가 true값이 나온다면 뒤의 조건(연산)은 궂이 실행되지 않음!!
	 *  
	 */
